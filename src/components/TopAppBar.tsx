        ...
        >
            <div className="flex h-16 items-center justify-between px-8">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <UserProfileSheet
                        trigger={
                            <button className="flex items-center justify-center h-12 w-12 rounded-full hover:bg-black/5 dark:hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
