...
export function GlobalSearchInput({ onClick, className }: GlobalSearchInputProps) {
  return (
    <div
      ...
      onClick={onClick}
    >
      <InputGroup className="h-12 rounded-2xl border-border/40 bg-background/50 backdrop-blur-sm group-hover:border-primary/40 group-hover:bg-background transition-all duration-300">
        <InputGroupAddon>
