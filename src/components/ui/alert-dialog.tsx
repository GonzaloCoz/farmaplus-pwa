...
const AlertDialogTrigger = React.forwardRef<
  HTMLButtonElement,
  React.ComponentPropsWithoutRef<typeof BaseAlertDialog.Trigger> & { render?: React.ReactElement }
>(({ render, ...props }, ref) => (
  <BaseAlertDialog.Trigger ref={ref} render={render} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <BaseAlertDialog.Description ref={ref} className={cn("text-sm text-muted-foreground", className)} {...props} />
));
