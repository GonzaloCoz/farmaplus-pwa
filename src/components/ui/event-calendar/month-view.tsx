                  ...
                  >
                    ...
                    >
                      {sortEvents(allDayEvents).map((event, index) => {
                        ...
                        if (isFirstDay || day.getDay() === 1) {
                          const sDate = safeParseDate(event.start);
                          return (
                            <div
                            ...
                            >
                              ...
                              >
                                <div aria-hidden={true} className="invisible">
                                  {!event.allDay && (
                                    <span>
                                      {isValid(sDate) ? format(sDate, "h:mm", { locale: es }) : "--:--"}{" "}
                                    </span>
                                  )}
                                  {event.title}
                                </div>
                      ...
                      {hasMore && (
                        <Popover>
                          <PopoverTrigger
                            render={
                              <button
                                className="mt-[var(--event-gap)] flex h-[var(--event-height)] w-full select-none items-center overflow-hidden px-1 text-left text-[10px] text-muted-foreground outline-none  transition hover:bg-muted/50 hover:text-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 sm:px-2 sm:text-xs"
                          ...
                          >
                            <div className="space-y-2">
                              <div className="font-medium text-sm text-capitalize">
