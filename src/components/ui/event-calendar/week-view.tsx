...
export function WeekView({
          ...
          if (col.length === 0) {
            ...
            const overlaps = col.some((c) =>
              areIntervalsOverlapping(
                ...
                {
                  end: safeParseDate(c.event.end),
                  start: safeParseDate(c.event.start),
                },
              ),
            );
  ...
  return (
    <div className="flex h-full flex-col" data-slot="week-view">
      <div className="sticky top-0 z-30 grid grid-cols-8 border-border/70 border-b bg-background/80 ">
