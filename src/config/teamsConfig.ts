...
const BRANCH_MAPPING: Record<string, string> = {
    ...
    "gonzales catan": TEAMS_RECIPIENTS.GHCOZ,
    "gonzales catan ii": TEAMS_RECIPIENTS.GHCOZ,
    "gonzales catan iii": TEAMS_RECIPIENTS.GHCOZ,
    ...
    "san isidro i": TEAMS_RECIPIENTS.EDIAZ,
