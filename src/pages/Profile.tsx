                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input defaultValue="Juan Pérez" className="pl-9" readOnly />
                            </div>
                        </div>
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input defaultValue="juan.perez@farmaplus.com" className="pl-9" readOnly />
                            </div>
                        </div>
                        <div className="space-y-2">
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input defaultValue="Sucursal Centro (001)" className="pl-9" readOnly />
                            </div>
                        </div>
                        <div className="space-y-2">
                            <Label>Rol</Label>
