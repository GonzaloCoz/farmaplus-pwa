        ...
        >
            ...
            <div>
                ...
                <p className="text-muted-foreground">
                    Selecciona la herramienta que necesitas para gestionar tu inventario
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {options.map((option, index) => (
                    ...
                    >
                        <Card
                            className="group relative overflow-hidden cursor-pointer transition-all hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]"
