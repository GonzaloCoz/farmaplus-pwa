...
import { Upload, FileSpreadsheet, AlertCircle, TrendingDown, TrendingUp, Download, CheckCircle, Target, Save } from "lucide-react";
        ...
        >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex flex-wrap gap-2">
              <Button onClick={handleExportSummary} variant="outline" className="hover:bg-primary hover:text-primary-foreground flex-1 sm:flex-none">
                <Download className="mr-2 h-4 w-4" />
                Exportar Resumen
              </Button>
              <Button onClick={handleExportForAdjustment} className="flex-1 sm:flex-none">
                <Download className="mr-2 h-4 w-4" />
                Exportar Inventario
              </Button>
              <Button
