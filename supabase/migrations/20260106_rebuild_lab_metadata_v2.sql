-- FORCE REBUILD OF BRANCH LABORATORIES (V2 - CONFLICT FIX)
-- This script fixes the "index already associated" error by dropping old objects first.

-- 1. CLEANUP: Drop potential conflicting constraints and indices
-- We ignore errors if they don't exist
ALTER TABLE branch_laboratories DROP CONSTRAINT IF EXISTS branch_laboratories_branch_lab_cat_unique;
...
DROP INDEX IF EXISTS branch_laboratories_branch_lab_cat_idx;
...
-- This automatically creates the necessary index
ALTER TABLE branch_laboratories 
ADD CONSTRAINT branch_laboratories_branch_lab_cat_unique 
