-- SQL Cleanup: Remove all versions of upsert_precount_item to fix ambiguity
-- Execute this in the Supabase SQL Editor

-- 1. Drop all known variations of the function to avoid "not unique" error
DO $$
DECLARE
    r RECORD;
BEGIN
    FOR r IN (SELECT oid::regprocedure as name 
              FROM pg_proc 
...
-- 2. Re-create the function with the modern structure
