-- ========================================================
-- Migración: Soporte para Re-Ajustes con Motivo
-- Fecha: 2026-03-12
-- ========================================================

-- 1. Agregar columna de motivo de re-ajuste a inventories
ALTER TABLE public.inventories 
ADD COLUMN IF NOT EXISTS readjustment_reason TEXT;

-- 2. Actualizar la función save_cyclic_inventory_v2
...
BEGIN
  ...
  LOOP
    ...
    -- Permitir actualización si fue explícitamente re-ajustado por el usuario
    IF v_current_status = 'adjusted' AND NOT COALESCE((item->>'wasReadjusted')::BOOLEAN, FALSE) THEN
        CONTINUE;
    END IF;
    ...
    DO UPDATE SET 
      ...
      readjustment_reason = COALESCE(EXCLUDED.readjustment_reason, inventories.readjustment_reason),
      category = EXCLUDED.category,
