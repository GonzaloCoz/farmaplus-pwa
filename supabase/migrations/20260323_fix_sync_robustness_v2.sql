-- =============================================
-- Migración: Robustez de Sincronización (VERSION CORREGIDA)
-- =============================================
...
-- 2. ELIMINAR VERSIONES ANTIGUAS (para evitar el error "is not unique")
-- Necesitamos especificar los argumentos para cada versión que queremos borrar
...
BEGIN
    ...
    IF v_existing_id IS NOT NULL THEN
        -- Actualizar existente con los nuevos valores acumulados
...
-- Otorgar permisos a todos los roles para evitar fallos de acceso
