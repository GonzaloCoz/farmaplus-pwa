-- ========================================================
-- UPDATE: branch_summaries VIEW (Añadiendo absolute_deviation_value)
-- Fecha: 2026-07-07
-- Propósito: Incluir el desvío absoluto valorizado en el monitor de sucursales
-- ========================================================
...
branch_inv_metrics AS (
    ...
    SELECT 
        ...
        ) as absolute_deviation_value, -- <--- NUEVA MÉTRICA VALORIZADA ABSOLUTA
...
SELECT 
    ...
    COALESCE(im.absolute_deviation_value, 0) as absolute_deviation_value, -- <--- EXPOSICIÓN DE LA NUEVA COLUMNA
...
COMMENT ON VIEW public.branch_summaries IS 'Vista en tiempo real para el Monitor de Sucursales. Incluye ajustes_value neto y absolute_deviation_value absoluto.';
